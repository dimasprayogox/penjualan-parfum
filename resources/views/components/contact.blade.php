<section id="contact" class="bg-gray-800">
    <div class="container px-6 py-12 mx-auto">
        <div>
            <h1 class="mt-2 text-2xl font-bold text-sky-600 md:text-4xl ">Contact us</h1>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">parfumboss@gmail.com</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Come say hello at our store HQ.</p>
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">ParfumBoss Perfume Store 123 Pahlawan Street, Madiun City, East Java</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+6281358199715</p>
                </div>
            </div>
